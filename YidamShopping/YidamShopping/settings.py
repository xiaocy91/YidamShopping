"""
Django settings for YidamShopping project.
...
SECRET_KEY = '3v7w7uophshnva*0irwa#pvb0endm9bz%j*fxnpyx2ja3s+mn9'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [u'192.168.0.100',u'127.0.0.1',]
...
ROOT_URLCONF = 'YidamShopping.urls'
...
WSGI_APPLICATION = 'YidamShopping.wsgi.application'
